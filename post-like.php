...
function get_like_count( $like_count ) {
	...
	$count = '<span class="sl-count">' . $number . ' ' . $text . '</span>';
	return $count;
} // get_like_count()
